...
def main():
    ...
    gradient_method = pruning_config.get(
        "gradient_method", "taylor"
    )  # "taylor", "gradient", or "magnitude"
    ...
    for task_name in tasks:
        for seed in seeds:
            ...
            mask_out_path = base_dir / task_name / f"seed_{seed}" / "mask_gradient.pkl"
            ...
            restored_state = checkpointer.restore(
                agent.state, item="checkpoint_best.pkl"
            )
